...
extension AINetworkCalls {
    ...
    /**
      ...
      Alexy
     */
    final class func handleResponse<T>(response: AFDataResponse<Any>, displayWarnings _: Bool, handleProgress: Bool? = nil, successCallback: GenericSuccessClosure<T>? = nil, errorCallback: GenericErrorClosure? = nil) where T: Decodable {
